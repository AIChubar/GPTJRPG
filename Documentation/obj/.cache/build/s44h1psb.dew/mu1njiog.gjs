...
<html>
  ...
  <head>
    <meta charset="utf-8">
      ...
      <title>Class PointGizmo
 | GPT JRPG Documentation </title>
      <meta name="viewport" content="width=device-width">
      <meta name="title" content="Class PointGizmo
 | GPT JRPG Documentation ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="Global.PointGizmo">


  <h1 id="Global_PointGizmo" data-uid="Global.PointGizmo" class="text-break">Class PointGizmo
</h1>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><span class="xref">PointGizmo</span></div>
  </div>
  <h6><strong>Namespace</strong>: <a class="xref" href="Global.html">Global</a></h6>
  <h6><strong>Assembly</strong>: Assembly-CSharp.dll</h6>
  <h5 id="Global_PointGizmo_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public class PointGizmo : MonoBehaviour</code></pre>
  </div>
  <h3 id="fields">Fields
</h3>


  <h4 id="Global_PointGizmo_radius" data-uid="Global.PointGizmo.radius">radius</h4>
