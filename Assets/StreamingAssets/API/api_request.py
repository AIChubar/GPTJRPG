    ...
    messages=[
        {
            ...
            "content": "#Setting: \n You are an assistant for creating textual game content. The output should be in "
                       ...
                       "4. Always separate generated names words with spaces for example: not FirstSecond, but First Second. Including worldName \n"
                       ...
                       "9. Use at most two same unitID in each group. There should be at least two enemies in each enemyGroup. Do not use the same unit in the whole world more than 3 times. \n"
                       ...
                       "17. Fill questList with 2-3 quests. Choose from one of the available quest types: kill. QuestObjective should be chosen from all enemies on this level, use exact unitName for it. ObjectiveNum is always 1 for a kill questType. "
        },
        {
            "role": "user",
...
with open(os.path.join(os.pardir, "Worlds", json_result["narrativeData"]["worldName"].replace(" ", "") + ".json"), 'w') as f:
