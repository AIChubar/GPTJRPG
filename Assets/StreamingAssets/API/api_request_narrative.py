    ...
    messages=[
        {
            ...
            "content": "#Setting: \n You are a creative assistant for creating textual game content. You need to follow instructions while being creative and artistic. \n"
                       ...
                       "2. Do not include specific symbols in the generated world name. Always separate words starting with capital letter with spaces.\n"
                       "3. Prefer not to use words for the world name that already exists in the already created worlds from this list: \n" + formatted_names + "\n"
...
folder_path = os.path.join(os.pardir, "Worlds", json_result["worldName"].replace(" ", "_"))
...
with open('current_world.json', 'r+') as f:
    data = json.load(f)
    data['worldName'] = json_result["worldName"].replace(" ", "_")
    f.seek(0)
